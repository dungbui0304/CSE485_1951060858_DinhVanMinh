    ...
    <div class="container">
        <div class="row ">
            <div class="col-md-12  hp-title">
                <h3 class="title-inline page_speed_230884138">
                    <a href="https://pystravel.vn/danh-muc-tour/2-tour-trong-nuoc.html" class="style-link-home">
                        <span class="name-tour">Tour hot </span>
                    </a>
                    <a href="https://pystravel.vn/danh-muc-tour/2-tour-trong-nuoc.html"></a>
            ...
            <div class="row text-center padding">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="img-item1">
                        <a href="" class="img-link">
                            <img src="./assest/img/tour2.jpg" alt="" class="img">
                        </a>
                    </div>
                    <div class="descriptions">
                        <p class="tittle">Hà Nội - Hòa Bình BaKhan Resort 4 sao 2 ngày 1 đêm</p>
